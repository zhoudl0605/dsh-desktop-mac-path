 ...
 * dshd-mac-path
 *
 * DSH Desktop on macOS only: restore the macOS login-shell PATH (Homebrew,
 * /etc/paths.d, ...) for agent shell commands running inside a
 * GUI-launched DSH Desktop host.
 *
